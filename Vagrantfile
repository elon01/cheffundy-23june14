...
Vagrant.configure("2") do |config|
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/elon_23june14"
  #   chef.validation_client_name = "elon_23june14-validator"
  #   chef.validation_key_path = ".chef/elon_23june14-validator.pem"
  # end
end
